...
async function main() {
  ...
  // Try sending SystemProgram for associated_token_program (what the deployed binary seems to expect)
  const keys = [
    ...
    { pubkey: SystemProgram.programId, isSigner: false, isWritable: false }, // 19: associated_token_program = SystemProgram (HACK for deployed binary bug)
  ...
  console.log("\n=== Simulating with SystemProgram as associated_token_program ===");
  try {
