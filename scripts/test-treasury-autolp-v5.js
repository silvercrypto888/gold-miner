...
async function main() {
  ...
  // NEW THEORY: deployed binary expects system_program at position 19, associated_token_program at position 20
  // (they're swapped compared to current source code)
  const keys = [
    ...
    { pubkey: ATA_PROGRAM_ID, isSigner: false, isWritable: false },       // 20: associated_token_program
  ];
  ...
  console.log("\n=== Simulating with system_program at 19, associated_token_program at 20 ===");
  try {
