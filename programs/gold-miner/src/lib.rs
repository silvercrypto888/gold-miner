...
pub const POOL_STATE: &str = "BZ8D8TVTcjBNcZNsQXGrESnNJTR89CHqyEZkxUfKqYzQ";
pub const GOLD_VAULT: &str = "4LqH8bbpmQbpXB4KB5JkeqxAUTN5a9FCQhShPbavP3FW";
pub const XNT_VAULT: &str = "6NSStSSSr49iLvVRFcDk9d9fq7cG6WqW7bKabtNJAncj";
pub const OBSERVER_STATE: &str = "9eQu1YHC6CS9TdQUjUeXtknD8yD83FH6EnuVXBtKaJmi";
...
pub const LP_MINT_ADDR: &str = "AwBykd7ni2zSX87ZeRnuGzyxBnkvky1ibmEgqBhd2vrf";
