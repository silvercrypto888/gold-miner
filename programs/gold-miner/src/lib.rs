...
pub const POOL_STATE: &str = "EJpboMDrMkoc3ZkTW6C8CnKuyP94rM9RuJyfFwr7TYij";
pub const GOLD_VAULT: &str = "61tYCBnU5sXTPUdQgfMPLCZR15XkFH2LbNPe5G2T6MrD";
pub const XNT_VAULT: &str = "3rs8Yj4GYqHWgXdAeap2L1W94Kj1Ga3YVkPswHGhv7ji";
pub const OBSERVER_STATE: &str = "D32A8xrkDK1a6Yi8Lwc9RBV4F9ueKVrzxR751o5PRbA5";
...
pub const LP_MINT_ADDR: &str = "4xvww8Yb8kAQAKxRBgsCCBgFBq8YEqKEKSjvTzrno8Rm";
