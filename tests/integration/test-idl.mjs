...
try {
  ...
  console.log('Data first 8 bytes (discriminator):', Array.from(ix.data.subarray(0, 8)));
  console.log('Keys:', ix.keys.map(k => ({ pubkey: k.pubkey.toBase58(), isWritable: k.isWritable, isSigner: k.isSigner })));
} catch (err) {
