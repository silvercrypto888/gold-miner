...
export const AMM_POOL_STATE = new PublicKey("BZ8D8TVTcjBNcZNsQXGrESnNJTR89CHqyEZkxUfKqYzQ");
export const AMM_GOLD_VAULT = new PublicKey("4LqH8bbpmQbpXB4KB5JkeqxAUTN5a9FCQhShPbavP3FW");
export const AMM_XNT_VAULT = new PublicKey("6NSStSSSr49iLvVRFcDk9d9fq7cG6WqW7bKabtNJAncj");
export const AMM_OBSERVER_STATE = new PublicKey("9eQu1YHC6CS9TdQUjUeXtknD8yD83FH6EnuVXBtKaJmi");
export const AMM_GOLD_MINT = new PublicKey("EarL8NaAje3mx5UGC86CWByVnotKgibkGmuJh6bHcWdz");
export const AMM_XNT_MINT = new PublicKey("So11111111111111111111111111111111111111112");
export const AMM_LP_MINT = new PublicKey("AwBykd7ni2zSX87ZeRnuGzyxBnkvky1ibmEgqBhd2vrf");
