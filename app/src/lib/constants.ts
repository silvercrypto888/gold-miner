...
export const AMM_POOL_STATE = new PublicKey("EJpboMDrMkoc3ZkTW6C8CnKuyP94rM9RuJyfFwr7TYij");
export const AMM_GOLD_VAULT = new PublicKey("61tYCBnU5sXTPUdQgfMPLCZR15XkFH2LbNPe5G2T6MrD");
export const AMM_XNT_VAULT = new PublicKey("3rs8Yj4GYqHWgXdAeap2L1W94Kj1Ga3YVkPswHGhv7ji");
export const AMM_OBSERVER_STATE = new PublicKey("D32A8xrkDK1a6Yi8Lwc9RBV4F9ueKVrzxR751o5PRbA5");
export const AMM_GOLD_MINT = new PublicKey("HAPJsAGEXkeE41VqcytFfUm3fMWiiz5baJFvCpDziyTa");
export const AMM_XNT_MINT = new PublicKey("So11111111111111111111111111111111111111112");
export const AMM_LP_MINT = new PublicKey("4xvww8Yb8kAQAKxRBgsCCBgFBq8YEqKEKSjvTzrno8Rm");
